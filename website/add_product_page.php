...
<body>
    ...
    <div class="container">
        <div class="content-individual">
            <form class="form" action="../php/add_item.php" method="post" style="box-shadow: 0 4px 8px rgba(0, 0, 0, 0.3), 0 6px 20px rgba(0, 0, 0, 0.3); border-radius: 12px; margin-top: 40px; padding-bottom: 20px;">
                <h2>Add Product</h2>
               ...
               <label>Product Classification:</label><br>
                <input type="text" id="product_classification" name="product_classification" required><br>
